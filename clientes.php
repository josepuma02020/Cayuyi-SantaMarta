                                ...
                                ?>
                                    <TR>
                                        ...
                                        <TD>
                                            ...
                                            <a href="historialcuotas.php?cliente=<?php echo $filas1['id_cliente'] ?>">
                                                <button type="button" id="historial" class="btn btn-secondary" data-toggle="modal" data-target="#editar">
