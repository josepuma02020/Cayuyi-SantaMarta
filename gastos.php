                                ...
                                <div class="modal-body" align="center">
                                    <div class="form-row">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input autocomplete="off"  type="text" style="font-size: medium" class="form-control input-group-sm" id="descripcion" name="descripcion" >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5">
                                            <label>Valor:</label>
                                            <input  autocomplete="off"   type="number" style="font-size: medium" class="form-control input-group-sm" id="valor" name="valor" >
                                        </div>
                                    </div>  
                                </div>
                        ...
                        <TBODY>
                            ...
                            while ($filas1 = mysqli_fetch_array($query)) {
                                ...
                                <TR>
                                    ...
                                    $tipo = $filas1['tipo'];
                                    switch ($tipo){
                                        case 1 : echo 'Moto';break;
                                        case 2: echo 'Gastos de Encargado';break;
                                        case 3:echo 'Pago a Encargado';break;
                                        case 4:echo 'Retiro Personal';break;
                                    }
                                        ?> </TD> 
