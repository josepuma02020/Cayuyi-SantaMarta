            ...
            <div  class=" container container-md" style="min-height: 40% "  align="left"  >
                ...
                <div class="card-body">
                    <div class="form-group col-md-3">
                        ...
                        <input   class="form-control input-sm" style=" width: 70%" type="date"id="desde" value="<?php echo $desde ?>">
                    </div>  
                    <div class="form-group col-sm-3">
                        <h3 style="font-family:  monospace;">Hasta:</h3>
                        <input   class="form-control input-sm" style=" width: 70%" type="date"id="hasta" value="<?php echo $hasta ?>">
